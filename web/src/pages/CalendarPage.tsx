...
export default function CalendarPage() {
  ...
  return (
    <div className="space-y-4">
      {/* Header row + calendar + sidebar, all in one grid so sidebar aligns to calendar top */}
      <div className="grid gap-x-4 gap-y-3 lg:grid-cols-[1fr_20rem]">
        {/* Row 1 col 1: title + nav */}
        <div className="flex items-center justify-between gap-4">
          <div>
            <h1 className="text-2xl font-semibold">Expiration Calendar</h1>
            <p className="mt-0.5 text-sm text-muted-foreground">
              Certificate expiration dates across all active endpoints.
            </p>
          </div>
